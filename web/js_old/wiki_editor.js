			...
			halloextrabuttons: {
				...
				buttons: [{
					action: function(event, button) {
						var summary = prompt("РљСЂР°С‚РєРѕ РѕРїРёСЃР°РЅРёРµ РЅР° РїСЂРѕРјРµРЅРёС‚Рµ");
						if (summary) {
					...
					icon: 'code',
					label: 'РР·С…РѕРґРµРЅ РєРѕРґ / РџСЂРµРіР»РµРґ',
					id: 'wikiSourceToggle'
				}, {
					...
					icon: 'times',
					label: 'РћСЃРЅРѕРІРµРЅ СЂРµР¶РёРј РЅР° РїСЂРµРіР»РµРґ'
				}]
			}
		},
		editable: true,
